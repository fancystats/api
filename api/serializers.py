...
Borrowed from flask-peewee, possibly add support for other formats.
...
from api.utils import get_dictionary_from_model
from api.utils import get_model_from_dictionary
